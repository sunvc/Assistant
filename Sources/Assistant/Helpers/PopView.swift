...
/// Config
struct PopViewConfig {
    public var backgroundColor: Color
    /// You can add extra properties here if you wish to.
    public init(_ backgroundColor: Color = Color.primary.opacity(0.25)) {
...
extension View {
    ...
    @ViewBuilder  func popView<Content: View>(
        config: PopViewConfig = .init(),
