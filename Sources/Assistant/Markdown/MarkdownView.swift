...
public struct MarkdownCustomView:View {
    ...
    public init( content: String, searchText: String = "", scaleFactor: CGFloat = 1.0) {
        ...
        if  !searchText.isEmpty{
            ...
            Markdown(content)
                .environment(\.openURL, OpenURLAction { url in
                    print("用户点击的链接是：\(url)")
                    openChatManager.openUrl(url: url)
    ...
    public static func highlightedText(searchText: String, text: String) -> Text {
        // 拆分关键词 & 小写比较用
