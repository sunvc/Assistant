...
public class Clipboard {
    ...
    public class func set(_ message: String? = nil, _ items:[String : Any]...) {
    ...
    public class func getNSAttributedString() -> NSAttributedString {
...
public enum Log: @unchecked Sendable {
    ...
    /// 默认日志输出函数（打印到控制台）
    nonisolated(unsafe) private static var logOutput: LogOutput = { message in
#if DEBUG
        debugPrint(message)
#endif
    }
   ...
   static func base(level: Level, file: String = #file, function: String = #function, line: Int = #line, _ message: Any...) {
    ...
    /// 打印调试日志
    public static func debug(file: String = #file, function: String = #function, line: Int = #line, _ message: Any...) {
        base(level: .debug, file: file, function: function, line: line, message)
    }
    
    /// 打印信息日志
    public static func info(file: String = #file, function: String = #function, line: Int = #line, _ message: Any...) {
        base(level: .info, file: file, function: function, line: line, message)
    }
    
    /// 打印错误日志
    public static func error(file: String = #file, function: String = #function, line: Int = #line, _ message: Any...) {
